...
;                                                          ; 35.79541643231187
@math( a^2 + 3 * ((a/2):sin + b:sqrt) ):print.             ; 35.79541643231187
...
; Which is why there is no `sin(x)` here and nothing to learn: anything that is
; an expression outside a region is one inside it, sends and all.
@math( b:sqrt + 1 ):print.               ; 4
