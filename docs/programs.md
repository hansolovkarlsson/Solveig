...
run the binaries as a shell would — **981<!--count claims--> claims on every build**, in about
...
two documents a newcomer actually reads. 438<!--count docs-claims--> claims
...
```text
[expect.sol](../programs/expect.sol) checks 981<!--count claims--> claims
```
