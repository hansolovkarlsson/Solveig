...
run the binaries as a shell would — **957<!--count claims--> claims on every build**, in about
...
two documents a newcomer actually reads. 428<!--count docs-claims--> claims
...
```text
[expect.sol](../programs/expect.sol) checks 957<!--count claims--> claims
```
