...
541<!--count examples-claims--> claims:
...
run the binaries as a shell would — **983<!--count claims--> claims on every build**, in about
...
two documents a newcomer actually reads. 440<!--count docs-claims--> claims
...
```text
[expect.sol](../programs/expect.sol) checks 983<!--count claims--> claims
```
