...
run the binaries as a shell would — **1001<!--count claims--> claims on every build**, in about
...
two documents a newcomer actually reads. 444<!--count docs-claims--> claims
across twenty-four<!--count docs-documents--> documents,
...
```text
[expect.sol](../programs/expect.sol) checks 1001<!--count claims--> claims
```
