...
| `make test SANITIZE="-fsanitize=address,undefined"` | the same, under the sanitizers. **Worth doing before a release** — see [POSTMORTEM.md](POSTMORTEM.md) 15. |
...
programs/       three real programs, each with its own README
