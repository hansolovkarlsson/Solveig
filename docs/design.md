...
That first shape was a *discovery* rather than a decision. The fourteen<!--count programs-->
programs in
...
this language*, which is a true sentence about fourteen<!--count programs--> programs
and an empty one
