...
That first shape was a *discovery* rather than a decision. The twenty-two<!--count programs-->
programs in
...
this language*, which is a true sentence about twenty-two<!--count programs--> programs
and an empty one
