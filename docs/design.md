...
That first shape was a *discovery* rather than a decision. The thirteen<!--count programs-->
programs in
...
this language*, which is a true sentence about thirteen<!--count programs--> programs
and an empty one
...
**0.34.0.** The language is Turing-complete, does not leak, and is what a
