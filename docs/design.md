...
That first shape was a *discovery* rather than a decision. The sixteen<!--count programs-->
programs in
...
this language*, which is a true sentence about sixteen<!--count programs--> programs
and an empty one
