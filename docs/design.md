...
That first shape was a *discovery* rather than a decision. The nineteen<!--count programs-->
programs in
...
this language*, which is a true sentence about nineteen<!--count programs--> programs
and an empty one
