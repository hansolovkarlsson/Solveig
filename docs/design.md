...
That first shape was a *discovery* rather than a decision. The fifteen<!--count programs-->
programs in
...
this language*, which is a true sentence about fifteen<!--count programs--> programs
and an empty one
