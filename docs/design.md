...
That first shape was a *discovery* rather than a decision. The twenty-one<!--count programs-->
programs in
...
this language*, which is a true sentence about twenty-one<!--count programs--> programs
and an empty one
