...
That first shape was a *discovery* rather than a decision. The twelve<!--count programs-->
programs in
...
this language*, which is a true sentence about twelve<!--count programs--> programs
and an empty one
