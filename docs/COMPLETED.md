...
| [programs.md](programs.md)'s sample output | 21 files, **398** claims | 22 files, **555**<!--count examples-claims--> claims |
| `README.md`, `programs.md` and the entry itself | **589** claims | **1001**<!--count claims--> |
