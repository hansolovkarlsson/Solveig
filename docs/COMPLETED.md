...
second reason — that the twenty-one<!--count programs--> programs are text and process
work, so geometry is
...
```text
[expect.sol](../programs/expect.sol) checks 1066<!--count claims--> claims
```
...
| [programs.md](programs.md)'s sample output | 21 files, **398** claims | 22 files, **588**<!--count examples-claims--> claims |
| `README.md`, `programs.md` and the entry itself | **589** claims | **1066**<!--count claims--> |
