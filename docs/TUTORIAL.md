...
- [lineage.md](lineage.md) — what Solveig borrowed and from whom, and what to
  expect if you already write Smalltalk, Ruby, JavaScript or C. Short, and the
  quickest way to stop being surprised.
...
- [examples/](../examples/) — thirty-seven<!--count examples--> more files, each taking one topic and
  showing it.
- [programs/](../programs/) — seven whole programs, each written to do a job
