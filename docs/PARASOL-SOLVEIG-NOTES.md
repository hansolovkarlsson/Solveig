...
roadmap says so. 3.28 and 3.30 closed on 2026-09-16.*
...
Entries 1 to 4 are numbered on the roadmap, and 2 and 4 are open; 5 is an
...
*Roadmap 3.30, [done](COMPLETED.md#330-the-machine-counts-instructions-and-will-not-say-how-many--done)
on 2026-09-16, as the first row of the table below.*
