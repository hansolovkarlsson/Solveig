...
**`programs/`** — twenty-three<!--count programs--> whole programs, each written to do a job and using
...
**`examples/`** — thirty-seven<!--count examples--> demonstrations, one for every concept the
