...
int main(void)
{
    ...
    /* Solveig's number spellings, which Parasol had one and a half of until
    ...
    /* A dictionary, and the one rule in Parasol where a context outranks a
    ...
    /* Blocks: parameters, temporaries, and the leading bar that tells them
       apart. Solveig's rule, and Parasol reads it the same way. */
