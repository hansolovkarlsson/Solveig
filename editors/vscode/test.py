...
# a plain identifier or bracket is named by its meta scope.
FIXTURE = [
    ('a := [#10, #20, #30].', [
        ('a', 'meta.identifier.solveig'), (':=', 'keyword.operator.assignment.solveig'),
    ...
    ('a:at(#1):print.   ; #10 -- first', [
        ('a', 'meta.identifier.solveig'), (':', 'punctuation.separator.send.solveig'), ('at', 'entity.name.function.send.solveig'),
    ...
    ('integer:upto := { | out, i |', [
        ('integer', 'meta.identifier.solveig'), (':', 'punctuation.separator.send.solveig'),
    ...
    ('{ a | | t | t }', [
        ...
        ('t', 'meta.identifier.solveig'), ('}', 'punctuation.section.block.end.solveig')]),
    ('{ x:print }', [
        ('{', 'punctuation.section.block.begin.solveig'), ('x', 'meta.identifier.solveig'),
        (':', 'punctuation.separator.send.solveig'), ('print', 'entity.name.function.send.solveig'),
        ('}', 'punctuation.section.block.end.solveig')]),
    ('b:do({ e | sum := sum:add(e) }).', [
        ('b', 'meta.identifier.solveig'), (':', 'punctuation.separator.send.solveig'), ('do', 'entity.name.function.send.solveig'),
        ...
        ('sum', 'meta.identifier.solveig'), (':=', 'keyword.operator.assignment.solveig'), ('sum', 'meta.identifier.solveig'),
        (':', 'punctuation.separator.send.solveig'), ('add', 'entity.name.function.send.solveig'),
        ('(', 'punctuation.section.group.begin.solveig'), ('e', 'meta.identifier.solveig'), (')', 'punctuation.section.group.end.solveig'),
    ...
    ('@expr(a | b | c).', [
        ...
        ('a', 'meta.identifier.solveig'), ('|', 'keyword.operator.solveig'), ('b', 'meta.identifier.solveig'),
        ('|', 'keyword.operator.solveig'), ('c', 'meta.identifier.solveig'), (')', 'punctuation.section.group.end.solveig'),
        ('.', 'punctuation.terminator.statement.solveig')]),
    ('@expr{ a | a^2 + 3*(sin(a/2) + sqrt(b)) }', [
        ...
        ('a', 'meta.identifier.solveig'), ('^', 'keyword.operator.solveig'), ('2', 'constant.numeric.float.solveig'),
        ...
        ('(', 'punctuation.section.group.begin.solveig'), ('a', 'meta.identifier.solveig'), ('/', 'keyword.operator.solveig'),
        ...
        ('b', 'meta.identifier.solveig'), (')', 'punctuation.section.group.end.solveig'), (')', 'punctuation.section.group.end.solveig'),
        ('}', 'punctuation.section.block.end.solveig')]),
    ('@expr(-2^2 <> -3.5e-1 & ~x >= $FF08)', [
        ...
        ('x', 'meta.identifier.solveig'), ('>=', 'keyword.operator.solveig'), ('$FF08', 'constant.numeric.hex.solveig'),
        (')', 'punctuation.section.group.end.solveig')]),
    ('sizes := #["small" = #1, "large" = n:mul(#2)].', [
        ('sizes', 'meta.identifier.solveig'), (':=', 'keyword.operator.assignment.solveig'),
        ...
        ('=', 'keyword.operator.pair.solveig'), ('n', 'meta.identifier.solveig'), (':', 'punctuation.separator.send.solveig'),
    ...
    ('"a\\tb\\q" \'sym %1010 45. x1 #-7 1.5', [
        ...
        ('x1', 'meta.identifier.solveig'), ('#-7', 'constant.numeric.integer.solveig'), ('1.5', 'constant.numeric.float.solveig')]),
    ...
    ('item:make := { n, p, q |\n    | it |\n    it := self:new }', [
        ('item', 'meta.identifier.solveig'), (':', 'punctuation.separator.send.solveig'),
        ...
        ('|', 'punctuation.separator.temporaries.solveig'),
        ('it', 'meta.identifier.solveig'), (':=', 'keyword.operator.assignment.solveig'), ('self', 'variable.language.self.solveig'),
    ...
    ('( | a, b | a:print )', [
        ...
        ('|', 'punctuation.separator.temporaries.solveig'), ('a', 'meta.identifier.solveig'),
        (':', 'punctuation.separator.send.solveig'), ('print', 'entity.name.function.send.solveig'),
        (')', 'punctuation.section.group.end.solveig')]),
]
