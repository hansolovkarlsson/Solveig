...
*Solum* is doing more work than the rest. As a noun it is the **ground** --
soil, floor, the base a thing stands on, which is what a virtual machine is to
the language above it. As an adverb, *sōlum*, it means **"only"**, which suits a
...
long ō and comes from *sōlus*, "alone"; and *sōl*, *sōlis* -- the sun -- is a
third root again. So the family does not share an etymology. It shares four
letters, and the names were chosen to lean on the resemblance.
